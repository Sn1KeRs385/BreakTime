 ...
 *      @OA\Property (property="find_in.kladr_id", type="string", nullable=true, description="Ограничения поиска по kladr_id", example="7700000000000"),
 *      @OA\Property (property="find_in.country_iso_code", type="string", nullable=true, maxLength=255, description="Ограничение по стране. Если имеется kladr_id, то приоритет поиска будет по нему. Если bound = country, то это поле не будет учитываться", example="RU"),
 *  )
 */
